...
public class PP_Rent_FarmHouse_Validation 
{
	...
	public static void main(String[] args) throws Throwable 
	{
		...
		//	new Select(propertytype_DD).selectByVisibleText("Farm House");
		//	Thread.sleep(3000);
			selectDD("propertyTypeRent", "Farm House");
			...
			//WaterAvailability Validation
				...
				boolean flag18=WaterAvailability.isDisplayed();
				System.out.println("WaterAvailability Displayed -->" +flag18);
				
			//CommonArea field validation
				WebElement CommonArea=driver.findElement(By.id("post-commonarea"));   
				boolean flag19=CommonArea.isDisplayed();
				System.out.println("CommonArea Displayed -->" +flag19);
						
			//PetsAllowed field validation
				WebElement PetsAllowed=driver.findElement(By.id("post-pets-allowed"));
				boolean flag20=PetsAllowed.isDisplayed();
				System.out.println("PetsAllowed Displayed -->" +flag20);
			...
			//RentDetails field validation
				...
				boolean flag23=RentDetails.isDisplayed();
				System.out.println("RentDetails Displayed -->" +flag23);
			
			//Response from field validation
				WebElement responsefrom=driver.findElement(By.id("post-responsefrom"));
				boolean flag24=responsefrom.isDisplayed();
				System.out.println("responsefrom Displayed -->" +flag24);
