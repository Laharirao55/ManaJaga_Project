...
public class RP_Rent_PentHouse_Validations
{
	...
	public static void main(String[] args) throws Exception  
	{
			...
			//select property from DD
				...
				new Select(propertytype_DD).selectByVisibleText("PentHouse");
				
				
				fieldvalidation("req-bedrooms");
				...
				fieldvalidation("req-face");
				fieldvalidation("req-opensides");
				fieldvalidation("req-tradetype");
				fieldvalidation("req-permission");
				fieldvalidation("req-rent-purpose");
				
				fieldvalidation("req-gcommunity");
				fieldvalidation("req-parking");
				fieldvalidation("req-poojaroom");
				fieldvalidation("req-otherroom");
				fieldvalidation("req-possession");
